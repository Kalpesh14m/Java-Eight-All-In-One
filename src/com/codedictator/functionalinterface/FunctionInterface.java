...
/*
 * Function is a functional interface. It is used to refer method by specifying
 * type of parameter. It returns a result back to the referred function.
 * 
 * Java Function Interface Methods ->
 * 
 * default <V> Function<T,V> andThen(Function<? super R,? extends V> after): It
 ...
 * function.
 * 
 * static <T> Function<T,T> identity(): It returns a function that always
